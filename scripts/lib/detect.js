...
function detect(projectRoot) {
  ...
  return Object.assign({}, base, { structure: detectStructure(root) });
}

module.exports = { detect, detectNode, detectRust, detectPython, detectGo, detectStructure, detectNodePackageManager };
