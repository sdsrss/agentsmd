# CODEX-CODING-SPEC v4.25.3 — Extended
...
→ `AGENTS-CHANGELOG.md`, beside this file in the install's `spec/` dir (single changelog for core + extended, outside the discovery chain).
