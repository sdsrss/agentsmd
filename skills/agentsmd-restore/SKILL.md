...
```bash
agentsmd_skill_run --list          # snapshots + purpose
agentsmd_skill_run                 # DRY-RUN — newest compatible snapshot
agentsmd_skill_run --confirm       # apply compatible snapshot
agentsmd_skill_run --id=<id> --confirm
```
